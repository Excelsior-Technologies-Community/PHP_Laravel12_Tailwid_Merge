...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    ...
    <div class="max-w-7xl mx-auto py-8 px-4">
        ...
        <div class="text-center mb-10">
            ...
            <button onclick="toggleTheme()"
                class="mt-4 ml-3 px-4 py-2 bg-black text-white dark:bg-white dark:text-black rounded-lg">
                🌙 Toggle Theme
            </button>
        </div>
        ...
        <!-- NEW FEATURE: Conflict Visualizer + Merge History -->
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">

            <h2 class="text-xl font-semibold mb-4">
                ⚠️ Tailwind Conflict Visualizer + 📜 Merge History
            </h2>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div id="conflictVisualizer"
                        class="bg-gray-100 dark:bg-gray-900 rounded p-3 min-h-[100px]">
                        No conflicts
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div id="mergeHistory"
                        class="bg-gray-100 dark:bg-gray-900 rounded p-3 min-h-[100px] overflow-y-auto max-h-[180px]">
                        No history
                    </div>
                </div>
    ...
    <script>
        ...
        function showConflicts(classes) {
            ...
            classes.forEach(cls => {
                ...
                if (
                    ['bg', 'text', 'p', 'm', 'px', 'py', 'rounded', 'shadow']
                    .includes(prefix)
                ) {
            ...
            document.getElementById(
                ...
                conflicts.map(c =>
                    ...
                    '<div class="text-red-500">' + c + '</div>'

                ).join('')

                :

                '<div class="text-green-500">No conflicts detected</div>';
        }
        ...
        function renderHistory() {
            ...
            document.getElementById(
                ...
                history.map(item =>
                    ...
                    '<div class="border-b p-1 text-xs font-mono">' + item + '</div>'
